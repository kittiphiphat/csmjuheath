    ...
    <header class="bg-white ">
        <nav class="flex justify-between items-center w-[90%]  mx-auto">
            ...
            <div class="flex items-center gap-6">
                ...
                <a href="/login"><button class="bg-[#a6c1ee] text-white px-5 py-2 rounded-full hover:bg-[#87acec] font-[Kanit]">เข้าสู่ระบบ</button></a>
                <a href="/register"><button class="bg-[#a6c1ee] text-white px-5 py-2 rounded-full hover:bg-[#87acec] font-[Kanit]">สมัครสมาชิก</button></a>
